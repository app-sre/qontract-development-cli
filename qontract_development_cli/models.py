...
class EnvSettings(BaseModel):
    ...
    run_qontract_api: bool = True
    run_qontract_api_worker: bool = True
    run_cache: bool = True
...
class ProfileSettings(BaseModel):
    ...
    qontract_api_config_compose_file: str = "api-config.yml.j2"
    ...
    def compose_template_files(  # noqa: PLR0913
        ...
        *,
        ...
        files += [self.qontract_api_config_compose_file] if api or worker else []
        return files
